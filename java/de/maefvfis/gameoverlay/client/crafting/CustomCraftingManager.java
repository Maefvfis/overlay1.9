...
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipeRepairItem;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipeTippedArrow;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesArmor;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesCrafting;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesDyes;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesFood;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesIngots;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesTools;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesWeapons;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesBanners;
import de.maefvfis.gameoverlay.client.crafting.recipes.ShapedRecipes;
import de.maefvfis.gameoverlay.client.crafting.recipes.ShapelessRecipes;
import de.maefvfis.gameoverlay.client.crafting.recipes.IRecipe;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipeBookCloning;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipeFireworks;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesArmorDyes;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesMapCloning;
import de.maefvfis.gameoverlay.client.crafting.recipes.RecipesMapExtending;
import de.maefvfis.gameoverlay.client.crafting.recipes.ShieldRecipes;
...
public class CustomCraftingManager
{
    ...
    private static final CustomCraftingManager instance = new CustomCraftingManager();
     ...
     */
    public static final CustomCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }
    ...
    public ItemStack findMatchingRecipe(CustomInventoryCrafting p_82787_1_, World worldIn)
    {
    ...
    public ItemStack[] func_180303_b(CustomInventoryCrafting p_180303_1_, World worldIn)
    {
        Iterator iterator = this.recipes.iterator();
